...
def generateThumbnails(dir_path, config, mosaic_type, file_list=None, no_stack=False, detection_only=False):
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('-d', '--detection_only', action="store_true", \
        help="""Use detection only frames.""")
    ...
    generateThumbnails(dir_path, config, 'mosaic', no_stack=cml_args.nostack, detection_only=cml_args.detection_only)
